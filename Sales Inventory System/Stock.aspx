<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stock.aspx.cs" Inherits="Sales_Inventory_System.Stock" %>
                                ...
                                <div class="panel-body">
                                    <div class="padd">
                                        ...
                                        <div class="form quick-post">
                                            ...
                                            <!-- Title -->
                                            <asp:RequiredFieldValidator ValidationGroup="Save" Display="Dynamic" ForeColor="Red" ControlToValidate="TxtProductName" ID="RequiredFieldValidatorTxtProductName" runat="server" ErrorMessage="Enter Product Name"></asp:RequiredFieldValidator>
                                            ...
                                            <asp:RequiredFieldValidator ValidationGroup="Save" Display="Dynamic" ForeColor="Red" ControlToValidate="txtQuantity" ID="RequiredFieldValidatortxtQuantity" runat="server" ErrorMessage="Enter Quantity"></asp:RequiredFieldValidator>
                                            <div class="form-group">
                                                <div class="col-lg-10">
                                            ...
                                            <asp:RequiredFieldValidator ValidationGroup="Save" Display="Dynamic" ForeColor="Red" ControlToValidate="txtcostprice" ID="RequiredFieldValidatortxtcostprice" runat="server" ErrorMessage="Enter Cost Price"></asp:RequiredFieldValidator>
                                            <div class="form-group">
                                                <div class="col-lg-10">
                                                    <asp:Label runat="server" Text="Cost Price" ForeColor="Blue"/>
                                                    <asp:TextBox ID="txtcostprice" placeholder="Cost Price e.g 100" runat="server" CssClass="form-control" TextMode="Number" AutoPostBack="True" OnTextChanged="txtcostprice_TextChanged"></asp:TextBox>
                                                </div>
                                            </div>
                                            <asp:CompareValidator ValidationGroup="Save" ID="CompareValidatortxtsellingprice" Display="Dynamic" ControlToValidate="txtsellingprice" ControlToCompare="txtcostprice" runat="server" ErrorMessage="Cost Price cannot be greater or equals to Selling Price" Operator="GreaterThan" ForeColor="Red" SetFocusOnError="True"></asp:CompareValidator>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-10">
                                                    ...
                                                    <asp:TextBox ID="txtsellingprice" placeholder="Selling Price e.g 100" runat="server" CssClass="form-control" TextMode="Number" AutoPostBack="True" OnTextChanged="txtsellingprice_TextChanged"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-lg-10">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-10">
                                                    ...
                                                    <asp:TextBox ValidationGroup="Save" ID="txtprofit" ReadOnly="true" runat="server" CssClass="form-control" TextMode="SingleLine"></asp:TextBox>
                                                </div>
                                            </div>
                                            <!-- Cateogry -->
